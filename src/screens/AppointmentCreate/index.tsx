...
export function AppointmentCreate() {
  ...
  function Validacao() {
    ...
    if (!category) {
      Alert.alert('Validação', 'Por favor selecione uma categoria', [{
        text: 'OK',
        style: 'cancel'
      }])
    ...
    if (!day) {
      Alert.alert('Validação', 'Por favor informe o dia', [{
        text: 'OK',
        style: 'cancel'
      }])
    ...
    if (!month) {
      Alert.alert('Validação', 'Por favor informe o mes', [{
        text: 'OK',
        style: 'cancel'
      }])
    ...
    if (!hour) {
      Alert.alert('Validação', 'Por favor informe o hora', [{
        text: 'OK',
        style: 'cancel'
      }])
    ...
    if (!guild.id) {
      ...
      Alert.alert('Validação', 'Por favor informe o servidor', [{
        text: 'OK',
        style: 'cancel'
      }])
